...
export default function AddMetaScreen({ navigation }) {
  ...
  const salvarMeta = async () => {
    ...
    try {
      ...
      const metas = storedData ? JSON.parse(storedData) : [];
      const novaMeta = { descricao, valor: parseFloat(valor), prazo: parseInt(prazo) };
      metas.push(novaMeta);
    ...
    <View style={styles.container}>
      {showAnimation ? (
        <View style={styles.animationContainer}>
          ...
          />
          <Text style={styles.sucessoTexto}>Meta adicionada com sucesso!</Text>
        </View>
      ) : (
        <>
